...
| 2026-08-06 | **F5 recoverability withdrawn; the split is ~12%, not ~18%** | Cutoff was inferred from an absence the CSVs cannot attribute; live P4 only corroborates |
...
| 6.0 | Consolidate everything into one deployed page per `006-one-page/BRIEF.md` | 🟡 | **BRIEF written 2026-08-06, awaiting approval.** Reverses three approved decisions (004 E1 "beside not part of"; SPEC §1 "make it look like Groupon — CUT"; new scope: a grounded data agent). Build order is unchanged — SPEC §10, and **step 4 still gates all UI**. Live-data positioning settled inside it |
